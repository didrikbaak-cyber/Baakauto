...
export const metadata: Metadata = {
  title: 'Våre biler',
  description:
    'Se utvalget av gunstige bruktbiler hos Baak Auto i Sandefjord. Finn din neste bil på Finn.no eller ta kontakt med oss.',
}
    ...
    <>
      ...
      <section className="bg-gradient-to-br from-[#1a3a5c] to-[#1e5fa8] text-white py-20 text-center px-4">
        ...
        <p className="text-white/80 text-lg max-w-xl mx-auto mb-9">
          Se vårt utvalg av bruktbiler på Finn.no. Utvalget oppdateres jevnlig.
        </p>
        <a
      ...
      <section className="max-w-6xl mx-auto px-4 py-14">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white border border-[#ccdcee] rounded-xl p-6">
            ...
            <h3 className="font-bold text-[#1a3a5c] mb-2">Bredt utvalg</h3>
            <p className="text-sm text-[#5a7a9a] leading-relaxed">
              Vi tilbyr et bredt utvalg av bruktbiler til konkurransedyktige priser.
            </p>
          </div>
          <div className="bg-white border border-[#ccdcee] rounded-xl p-6">
            ...
            <p className="text-sm text-[#5a7a9a] leading-relaxed">
              Vi kan levere med garanti, slik at du er trygg også etter kjøpet.
            </p>
          </div>
          <div className="bg-white border border-[#ccdcee] rounded-xl p-6">
            <div className="w-10 h-10 bg-[#e8f1fb] rounded-xl flex items-center justify-center text-xl mb-4">🔄</div>
